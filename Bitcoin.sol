...
contract Bitcoin is ERC20, Ownable {
    ...
    constructor() ERC20("Bitcoin", "BITC") {
        ...
        uint256 totalSupply = 10000e6 * 1e18;

        maxBuyAmount = totalSupply * 4 / 10; // 4% maxTransactionAmountTxn
        maxSellAmount = totalSupply * 4 / 10; // 4% maxTransactionAmountTxn
        maxWalletAmount = totalSupply * 4 / 10; // 4% maxWallet
        thresholdSwapAmount = totalSupply * 4 / 10; 
        ...
        marketingWallet = address(0x6edb4371cE061BE157118c917e59147d93132a79);
        devWallet = address(0x6edb4371cE061BE157118c917e59147d93132a79);
    ...
    function calculateFees(bool isSell, uint256 amount) internal view returns (uint256) {
    if (isSell) {
        return amount.mul(_fees.sellTotalFees).div(100);
    } else {
        return amount.mul(_fees.buyTotalFees).div(100);
    }
}

function distributeFees(bool isSell, uint256 fees) internal {
    if (isSell) {
